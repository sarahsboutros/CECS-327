...
public class Chat implements Serializable
{
	...
	/**\brief Enum Class to keep track of message Ids**/
	...
	/*****************************/
	/**
	 * \brief This class implements a peer. It keeps the information of our peer
	 * simulating a doubly-linkedlist.
	 **********************************/
	...
	/*****************************/
	/**
	 * \brief This class implements a main message. It keeps all the information
	 * the user would like to send to its peers.
	 **********************************/
	...
	public class Server implements Runnable
	{
		...
		public void run()
		{
			try
			{
				...
				while (true)
				{
					Socket clntSock = servSock.accept(); // Get client
					                                     // connections
					...
					try
					{
						...
						switch (m.messageID)
						{
							case JOIN:
								...
								ObjectOutputStream oj = new ObjectOutputStream(socketJ.getOutputStream());
								oj.writeObject(join);
								socketJ.close();
							...
							case ACCEPT:
								...
								ObjectOutputStream oa = new ObjectOutputStream(socketA.getOutputStream());
							...
							case PUT:
								...
								} else
								{
									...
									ObjectOutputStream po = new ObjectOutputStream(socketP.getOutputStream());
									po.writeObject(m);
									socketP.close();
								}
								break;
			...
			while (true)
			{
				try
				{
					...
					else if (cmd.equalsIgnoreCase("LEAVE"))
					{
						...
						ObjectOutputStream oostwo = new ObjectOutputStream(sockettwo.getOutputStream());
						ObjectInputStream oistwo = new ObjectInputStream(sockettwo.getInputStream());

...
public class Chord extends java.rmi.server.UnicastRemoteObject implements ChordMessageInterface
{
    ...
    public void put(int guid, InputStream file) throws RemoteException, FileNotFoundException,IOException
    {
        ...
        String path = ".//" + this.getId() + "//repository//" +guid;
    ...
    public void delete(int guid) throws RemoteException,FileNotFoundException {
        File file;
        String path = ".//" + this.getId() + "//repository//" +guid;
        file = new File(path);
        file.delete();
    ...
    public void notify(ChordMessageInterface j) throws RemoteException
    {
        ...
        {    // TODO
            ...
            Path path = Paths.get(".//" + this.getId() + "//repository//");
